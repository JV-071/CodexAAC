          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#252525]/95 backdrop-blur-sm rounded-xl border-2 border-[#505050]/70 p-6 sm:p-8 shadow-2xl ring-2 ring-[#ffd700]/10">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-[#1f1f1f]/80 rounded-lg border border-[#404040]/50 hover:border-[#ffd700]/60 transition-colors">
                  <div>
                    <h3 className="text-[#e0e0e0] font-bold mb-1">Map Editor</h3>
                    <p className="text-[#888] text-sm">Create and edit custom maps for your adventures</p>
                  </div>
                  <a
                    href="#"
                    className="bg-[#3b82f6] hover:bg-[#2563eb] text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
                  >
                    Download
                  </a>
                </div>
                <div className="flex items-center justify-between p-4 bg-[#1f1f1f]/80 rounded-lg border border-[#404040]/50 hover:border-[#ffd700]/60 transition-colors">
                  <div>
                    <h3 className="text-[#e0e0e0] font-bold mb-1">Client Launcher</h3>
                    <p className="text-[#888] text-sm">Alternative launcher with additional features</p>
                  </div>
                  <a
                    href="#"
                    className="bg-[#3b82f6] hover:bg-[#2563eb] text-white font-bold py-2 px-4 rounded-lg transition-colors text-sm"
