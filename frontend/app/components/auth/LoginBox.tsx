...
export default function LoginBox() {
	...
	const { isAuthenticated, isLoading, setAuthenticated, logout } = useAuth()
		...
		return (
			<div className="bg-[#252525]/95 backdrop-blur-sm rounded-xl border-2 border-[#505050]/70 p-4 sm:p-6 shadow-2xl ring-2 ring-[#ffd700]/10">
				...
				<div className="space-y-4">
					...
					<button
						onClick={logout}
						className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-2.5 sm:py-3 px-4 rounded-lg transition-all shadow-lg hover:shadow-xl transform hover:scale-[1.02] text-sm sm:text-base"
					>
						Logout
					</button>
				</div>
